...
```
git clone https://github.com/trueberryless-org/withastro-github-comment-templates
```
...
More information about contribution can be found unter [CONTRIBUTING.md](https://github.com/trueberryless-org/withastro-github-comment-templates/blob/main/CONTRIBUTING.md).

## License

Licensed under the GNU General Public License v3.0, Copyright © trueberryless.

See [LICENSE](https://github.com/trueberryless-org/withastro-github-comment-templates/blob/main/LICENSE) for more information.
